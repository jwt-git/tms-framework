package net.juweitang.tms.common.mail.sender;

import java.util.concurrent.Executor;
import java.util.concurrent.Executors;

import net.juweitang.tms.common.mail.context.MailContext;
import net.juweitang.tms.common.mail.render.MailRender;
import net.juweitang.tms.common.mail.render.impl.SimpleMailRender;
