...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Link','Unlink','Anchor'],
	'/',
	['OrderedList','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],	
	['TextColor','BGColor'],
	['FontName','FontSize']
...
// 前台发布资讯使用的,删掉部分功能
FCKConfig.ToolbarSets["toolbar_web_comm"] = [
    ['Cut','Copy','Paste'],
    ['Undo','Redo','-','SelectAll'],
    ['Bold','Italic','Underline','StrikeThrough'],
    ['Table'],
...
FCKConfig.FontNames		= '宋体;隶书;楷体;黑体;幼圆;微软雅黑;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
...
//modify by wuyb 2010-08-26 posgoo
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/connectors/upload.htm';
